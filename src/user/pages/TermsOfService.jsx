...
const TermsOfService = () => {
  return (
    <div className="flex justify-content-center p-4 bg-main3 min-h-screen">
      <div className="w-full md:w-8 lg:w-6 border-1 surface-border border-round-2xl shadow-2 p-4 bg-white">
        ...
        <p>
          Khi đăng ký tài khoản và sử dụng hệ thống, bạn đồng ý tuân thủ đầy đủ
          các điều khoản sau:
        </p>
        ...
        <p>
          Người dùng chịu trách nhiệm về thông tin cung cấp. Hệ thống không chịu
          trách nhiệm khi người dùng tự ý áp dụng thông tin mà không hỏi ý kiến
          bác sĩ.
        </p>

        <h4>5. Điều khoản bổ sung</h4>
        <p>
          Một số tính năng sẽ triển khai sau. Điều khoản có thể thay đổi, người
          dùng cần theo dõi cập nhật.
        </p>
      </div>
    </div>
  );
