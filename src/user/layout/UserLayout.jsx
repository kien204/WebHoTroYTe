...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen">
      <div className="hidden w-17rem md:block bg-white border-r surface-border min-h-screen flex-shrink-0">
        <MenuSidebar />
      </div>
      ...
      {sidebarVisible && (
        <div className="fixed inset-0 z-5 flex md:hidden">
          ...
          />
          <div className="relative w-17rem  min-h-screen bg-white shadow-2 z-10 animate-slide-in">
            <MenuSidebar />
          </div>
        </div>
      )}
